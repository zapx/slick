...
function updateAngularJson(path: string, options: any) {
    return (host: Tree) => {
        ...
        const workspaceObj: experimental.workspace.WorkspaceSchema | any = JSON.parse(
            workspaceContent,
        );
        ...
        const workspaceOptions =  workspaceObj.projects[projectName].architect.build.options;
